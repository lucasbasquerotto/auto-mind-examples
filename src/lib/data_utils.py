...
def unicode_to_ascii(s: str, allowed_letters: str | None = None) -> str:
...
def normalize_string(s: str, allowed_letters: str | None = None) -> str:
...
def offsetify(tensors: list[Tensor]) -> Tensor:
